...
public sealed class Movie : EntityBase
{
    ...
    private Movie(string title, string genre, DateOnly releaseDate, double rating)
    {
        Title = title;
        Genre = genre;
    ...
    public static Movie Create(string title, string genre, DateOnly releaseDate, double rating)
    {
        ValidateInputs(title, genre, releaseDate, rating);
        return new Movie(title, genre, releaseDate, rating);
    }

    public void Update(string title, string genre, DateOnly releaseDate, double rating)
    {
        ValidateInputs(title, genre, releaseDate, rating);
        Title = title;
        Genre = genre;
    ...
    private static void ValidateInputs(string title, string genre, DateOnly releaseDate, double rating)
    {
